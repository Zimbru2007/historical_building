...
TIMEOUT=15
QUIET=0
rm /data/mongo-replica.flag
sleep 10 | echo 'sleep to wait hbmongodb1'

wait_for() {
  for i in `seq $TIMEOUT` ; do
    mongo mongodb://hbmongodb1:27017/las --eval "db.stats()" > /dev/null 2>&1
    result=$?
...
if [ ! -f /data/mongo-init.flag ]; then
    ...
    mongo mongodb://hbmongodb1:27017 mongo-setup.js
